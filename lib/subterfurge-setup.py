...
#Scapy
try:
   os.system("apt-get -y -qq install python-scapy")
except:
   print "[!] Critical package failed to install: python-scapy"

#Python-Twisted
try:
   os.system("apt-get -y -qq install python-twisted")
except:
...
#Python-Django
try:
   os.system("apt-get -y -qq install python-django")
except:
   print "[!] Critical package failed to install: python-django"

#Arptables
try:
   os.system("apt-get  -y -qq install arptables")
except:
   print "[!] Critical package failed to install: arptables"

#DHCPD
try:
   os.system("apt-get -y -qq install dhcpd")
except:
